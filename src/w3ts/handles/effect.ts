...
import { Orientation } from "lib/classes/position/interfaces/Orientation"
import { IVector } from "lib/classes/vector/interfaces/IVector"
...
export class Effect extends Handle<effect> {
  ...
  constructor(modelName: string, a: number | Widget | Coordinate, b?: number | string | Orientation) {
    if (Handle.initFromHandle()) {
      ...
      if (a.z) {
        BlzSetSpecialEffectZ(this.handle, a.z)
      }
      if (b) {
