...
export class Color {
  ...
  public constructor(readonly red: ColorValue, readonly green: ColorValue, readonly blue: ColorValue, alpha?: ColorValue) {
    if (alpha) {
      this.alpha = alpha
    } else {
      this.alpha = 255
...
export const color = (red: ColorValue, green: ColorValue, blue: ColorValue, alpha?: ColorValue): Color => new Color(red, green, blue, alpha)
